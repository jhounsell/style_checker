function checkTextRules(userText) {
  ...
  const regexPatterns = [
    ...
    { regex: /[A-Z]+\s([A-Z]\s?)+[?.!:;-]/g, message:"Do not use BLOCK CAPITALS.", title: "Block capitals" },
    ...
    { regex: /(?<![.?!]\s)(?!email)[eE][\u002D\u2013\u2014\u2012\u2015\u2212\u00AD\uFE58\uFF0D\s]?mail/g, message: "Lower case and spell as 1 word.", title: "email" },
    ...
    { regex: /\bdata\s((?!\w+s\b)|do\b|are|have|go\b|arise\b|become\b|begin\b|break\b|come\b|fall\b|fly|grow\b|run\b|rise\b|sink\b|stand\b|strike\b|take\b|undergo\b|withdraw)\w+/gi, message: "Treat as a singular noun: The data is stored on a secure server.", title: "data" },
    ...
    { regex: /(\d\d?\s)?(\bjan\b|\bfeb\b|\bmar\b|\bapr\b|\bmay\b|\bjun\b|\bjul\b|\baug\b|\bsep\b|\boct\b|\bnov\b|\bdec\b|january|february|march|april|may|june|july|august|september|october|november|december)/g, message: "Upper-case the first letter on months.", title: "months (case)" },
