function checkTextRules(userText) {
  ...
  const regexPatterns = [
    ...
    { regex: /(\bclick(ed|s|able)?|\btap\b)/gi, message: "Use select rather than click or tap because not everyone uses a mouse.", title: "Click"},
    ...
    { regex: /(?<!(absolute|(un)?qualified|exercis((e(d|s)?)|ing)(?:\s+of)?\s+(?:my|her|his|your|their|our|this|that|any|a|such|the))\s)(?<!(statutory|legal|contractual)(?:\s+)?)\bright\b(?!\s+(?:,?\s*)?(?:not\s+)?to\b)(?!\sacross)(?!-to-)/gi, message: "Use correct rather than right.", title: "Correct"},
    ...
    { regex: /(?<!GOV\.UK\sOne\s)(\blog[\s\u002D\u2013\u2014\u2012\u2015\u2212\u00AD\uFE58\uFF0D]ins?\b|\blogins?\b)/gi, message: "Use 'sign in' rather than 'log in'.", title: "Sign in"},  
    ...
    { regex: /([G]lobal\s[tT]alent\s|[hH]igh\s[pP]otential\s|[gG]raduate\s|[fF]amily\s|Ukraine\s|[mM]obility\s|[vV]isitor\s|[bB]usiness\s|[bB]ritish\s[nN]ational\s?(\(*[oO]verseas\)*\s*)*|([sS]killed\s|[tT]emporary\s|[sS]econdment\s)\s[wW]orker\s|[rR]ight\s[oO]f\s[aA]bode\s|[tT]ier\s[1-5]\s|[tT]ransit\s|[mM]arriage\s|[sS]tudent\s|[sS]tudy\s|[sS]cheme\s|[rR]epresentative\s|[sS]cale[\s\u002D\u2013\u2014\u2012\u2015\u2212\u00AD\uFE58\uFF0D][uU]p\s|[fF]ounder\s|[sS]pouse\s|[pP]artner\s|[aA]ncestry\s|[rR]eunion\s|[rR]efugee\s|[aA]sylum\s|[dD]ependant\s|[sS]ettlement\s|ILR\s|[rR]emain\s|EUSS\s|[mM]ember\s|[sS]tart[\s\u002D\u2013\u2014\u2012\u2015\u2212\u00AD\uFE58\uFF0D][uU]p\s|[rR]esident\s).*[rR]outes?.*/g, message: "Use 'visa' rather than terms like 'route'. For example, use 'graduate visa' rather than 'graduate route'.", title: "visa"},
